      ...
      Creatous Collective
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <nav className="hidden md:flex gap-6">
            <a href="#Home" className="font-glacial text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[20px] uppercase hover:text-gray-700">
              Home
            </a>
            <a href="#our-brands" className="font-glacial text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[20px] uppercase hover:text-gray-700">
              Our Brands
            </a>
          </nav>
