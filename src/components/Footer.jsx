      ...
      <div className="relative mx-auto text-center ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left">
          ...
          <div className="w-full md:w-1/3 flex justify-center md:justify-start mb-6 md:mb-0">
            <a
              href="mailto:creatouscollective@gmail.com"
              className="text-black md:text-[22px] sm:text-[18px] font-[Montserrat]"
            >
              creatouscollective@gmail.com
            </a>
          </div>
          ...
          <div className="w-full md:w-1/3 flex justify-center space-x-8 text-2xl mb-6 md:mb-0">
            ...
            <a
              href="https://www.linkedin.com/company/creatous-collective-media/?originalSubdomain=in"
              target="_blank"
              rel="noopener noreferrer"
        ...
        {/* Copyright */}
        <p className="text-[12px] sm:text-xs md:text-sm font-[Montserrat]">
